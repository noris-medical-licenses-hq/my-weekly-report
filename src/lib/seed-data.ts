...
export const SEED_TOPICS: Topic[] = [
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. תקלת רשת אינטרנט במשרד ביום שלישי הציפה את הסיכון באי זמינות שרת הקבצים המקומי במהלך מבדק
...
2. מיפוי משימת VPN, בניית תוכנית עבודה להמשך בהתאם לעדיפויות`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. הועבר לאחריות יוליה לפני תחילת המלחמה
...
2. ממשיכים לשלם עלויות IFU מודפס בגובה עשרות אלפי ₪ ברבעון`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. סטאטוס קודם: התקבלה הצעת מחיר מספק בגרמניה, המוצר שהוצג עונה על הצרכים שלנו, עלויות אחזקה גבוהות (SaaS)
2. התקיים דיון (אצלי במשרד) בשבוע שעבר, יש צורך בבחינת חלופות בארה"ב לפני התקדמות`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. הפעילות אינה נתמכת מהמטה מאז תחילת המלחמה
...
2. פעילויות המשך לאחר העליה לאוויר דורשות ניהול (פערים, פיתוחים נוספים)`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. התקיימו שתי פגישות השבוע להתנעת הפרויקט ותחילת איפיון הצרכים
...
2. ע"מ להשלים את הפרויקט בסד זמנים סביר, נדרש מנהל פרויקט`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. נראה שהתוכנה שאישרנו לרכוש מוכיחה את עצמה, גובו עד כה כ100 תיבות המיועדות לסגירה.
...
2. גיבוי על כונן חיצוני פיזי, לא משתלם לקחת שרת ענן בשביל הגיבוי (החלפת עלות רישוי תיבות בעלויות ענן)`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. החלה התקנת EDR על מחשבי החברה
...
2. מיפוי המחשבים בחו"ל וקבלת החלטה על אופן ההגנה עליהם`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. חידוד איפיון הצורך: מנהל שיודע להתמודד עם מגוון אתגרים טכניים המטופלים ע"י אנשי מקצוע שונים, ולא איש טכני עם התמחות ספציפית
...
2. עקב מורכבות התפקיד והיעדר חלק מהידע הרלוונטי - במידה ונקלוט אותה לעבודה, תהיה עקומת למידה לא קצרה (יותר מכמה שבועות) עד כניסה מלאה לתפקיד`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. דננג'יי צפוי לסיים את תפקידו בקרוב, הוחלט שלא לגייס מחליף עד להגעת מנהלת התפעול החדשה (סמיתה)
...
2. מעבר מידע חלקי, תיקי חפיפה (טובים ככל שיהיו) לא מחליפים חפיפה פרונטלית`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. נפילת רשת האינטרנט ביום שלישי, קו פרשת מים בהתנהלות מול שלושת הגורמים שמטפלים בנושא
...
2. רכישת מקלטי WiFi למחשבים נייחים שיאפשרו עבודה עם hotspot במקרה של השבתה עתידית`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1.  איפיון ויישום פיתוח פריוריטי להכנת ניירת COC להודו - משימה שבועית של שעתיים-שלוש שתהפוך ל2-3 דקות 
2. מומלץ  לבחון אפשרות לקב"מ In-house במשרה חלקית לצורך קידום פרויקטי פריוריטי `,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. מעבר לאופיס 365
...
2. לא נראה שיש היתכנות בטווח הנראה לעין לתחילת הביצוע של הפרויקטים`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. הוחלף הגלאי שנתן קריאות שווא במשך תקופה ארוכה
...
3. קבלת הצעת מחיר להחלפת מערך המצלמות, הצעה נוספת תתקבל בשבוע הבא`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. דרישה מצד חברת הביטוח להשלמת הפערים עד ה30.4
...
2. בכפוף לאישור: קידום רכש כספות , קידום רכש מחולל עשן, קידום מעבר פיזי של מחסן ישראל`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. נדב: גיוס מוצלח (פלנר גלובלי), נכנס היטב לתפקיד
...
4. יונתן (משלוחים): התחיל ביום ראשון, מבצע חפיפה עם נדב, נראה שנמצא בכיוון הנכון, מוקדם להעריך סיכויי הצלחה`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. נדב ממשיך בהתקדמות שלו, מתפתח יפה מאוד לכיוון של מנהל שרשראות אספקה שאליו הוא מיועד
...
3. חניה בחניון התת קרקעי לפי אותם תנאים של שגיב`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. מועמדת לתפקיד מנהלת מערכות מידע (פירוט בסעיף קודם בדו"ח)`,
    risksAndChallenges: ``,
    nextWeekPriority: ``,
    supportRequired: ``,
  }),
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. גיא הגיש מכתב התפטרות, לפי המאוחר מבין 10/5 וסיום המילואים שלו
...
4. עשויה להתאים לתפקיד של אנליסטית, תלוי מאוד במוטיבציה שלה להצליח וברצון/מוכנות שלנו להשקיע`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. מועמדים למשרות הייצור שמגיעים מלשכת התעסוקה אינם ברמה המספקת, או דורשים שכר גבוה מזה שאנחנו משלמים
2. תעסוקת נוער נותנת מענה זמני במהלך חופשה הפסח`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. החלטה לעצור תהליך עם HR home
2. רמת המועמדים המגיעה מלשכת התעסוקה מפתיעה ברמה הגבוהה שלה (בהשוואה למועמדים שהגיעו דרך חברות השמה)`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. עלייה בשכר המינימום מחודש אפריל
...
2. החלטה על מועד עדכוני שכר`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. רמות מלאי סבירות (2-3 חודשי מלאי)
2. חוסרים במידות קצה
...
3. אין למשרד במומבאי יכולת לבצע תכנון הזמנות שלוקח בחשבון את יכולת התפוקה, מבוצע אצלנו`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. הגעת משלוח NG של מוצרי high-runner בכמויות גדולות בהתאם לפידבק מאלנה
...
2. בניית מלאי של קו מוצרים שלם של NG תקח זמן, המיקוד יהיה במוצרי high-runner  (סוכם על מוצרים בעדיפות ראשונה)`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. התייצבות ברמות המלאי בהתאם לתוכנית עבודה ממוקדת
...
3. נדרשת פעילות של הצוות המקומי "להכשרת: מוצרי NG, כך שיוכלו למשוך מוצרים ממלאי גרמניה`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. ערוץ התקשורת בין קרול לנדב עובד היטב
2. המשלוחים למחסן נעשים לפי צורך, לרוב מדובר בהזמנות קטנות`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. נסיעה למחסן בהודו נדחתה עקב המלחמה, לא בוצעה ספירת מלאי בסוף השנה 
...
2. קידום תהליך תמחור מוצרים מול DAND`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. המדפסת הגיעה לספק, ונמצאת בתהליך אינטגרציה
...
3. החלטה מי נוסע`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. היקפי ייצור משמעותיים מאוד מאז החזרה לשגרה
...
3. משלוחי קטן לקולומביה`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1.ההזמנה אושר, התקבלה חשבונית לתשלום מקדמה ע"ס 50%
...
2. ישיבת kick-off עם אנה וקטיה, ותחילת עבודה על היתר הרעלים`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. התקיים דיון על מבנה התהליכים ועצי המוצר בפריוריטי לצורך תמיכה במתקן
...
`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. קופסת תצוגה שחורה (NM-X2010), נדרש עדכון נוסף של קבצי הייצור (חירור, גרפיקה), עיכוב של 1-2 שבועות נוספים בתהליך
...
5. נדרשת עליה בקצב אספקות שתלי Tuff בקוטר 4.2 מ"מ, יטופל מול DAND`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. התקבל משלוח ראשון של הזמנה סדרתית, חסכון משמעותי בעלויות
...
2. בחינת אפשרות להחזרת החלקים הפסולים לצורך ביצוע ניקיון`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. ביקור אצל הספק בסין, מפעל ברמה גבוהה
2. תחילת תהליך לבדיקת היתכנות לייצור עצמאי של קופסאות קיטים`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. הוחלט להוציא הזמנה לברגים, תיושם כחלק מתוכנית הרכש לחודש אפריל שמתוכננת לשבוע הבא
2. קבלת משלוח ראשון של אנלוגים דיגיטליים, רמת איכות גבוהה, הוזלה של מעל 60% בעלות הייצור`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. צפי לחזרה לשגרה השבוע בהתאם להפסקת האש בצפון
...
2. לא ברורה היכולת בייצור חלקים מסובכים, חובת ההוכחה עליו`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. הושלמו מנות הייצור בחדר הנקי הנדרשות לצורך הבדיקות
...
2. הציר הקריטי בפרויקט הוא ביצוע בדיקות ואישור הרשויות המתאימות על האתר המשני, קבועי זמן של חודשים מתחילת תהליך`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. התקיימו שתי פגישות עם חברת הרגולציה (NKG)
...
4. ייתכן שהפתרון הפיננסי לסעיף 2 יאפשר יישום בטווח קצר יותר של העברת המוצרים במחיר מופחת, עוד לפני בניית התהליך החדש`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. הזמנו דוגמאות של 50+ סוגי מקדחים מFFDM
...
4. הוצאת היקף עבודה משמעותי מכרמקס צפוי להשפיע על היחסים`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. קוסטה הוא השותף לשעבר של ניקולא חורי, במסגרת השותפות שלהם הוא זה שהביא את הידע הטכני ובעוד ניקולא התמקד בצד המסחרי/שיווקי
...
6. לאחר הביקור חתם על NDA`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. דרישה מוגברת לציוד לקורסים (ערכות, שתלי dummy)
2. חידוש ערכות ארה"ב מתעכב עקב אי זמינות מקדחי יהלום`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. התנעה ראשונה של הפעילות
...
2. הפעילות תדרוש משאבים משמעותיים של זמן וכסף`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. פגישת זום עם פאבל מהחברה בסלובקיה (Sky Medical)
...
3. תיאום ביקור אצל הספק`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. התשובה מפרסיבר על המולטי יוניט מאיצה את הצורך בקידום חלופות ייצור נוספות בחו"ל`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. ייצור התבניות אצל הספק הסיני לא הצליח
...
2. נדרש פוקוס מצידינו לקידום התהליך, מומלץ להעביר לאחריות מחלקת ההנדסה בתמיכה שלי בצד המסחרי מול הספק`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. תקשורת רציפה מול הספק, מתקדם עם הייצור
2. נדרש ביקור אצל הספק כדי להבין יכולות ובחינת אפשרות להרחבת פעילות`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. התקבלה החלטה לקדם הסכם עם המחסן בברזיל לשנה
2. התהליך מול המחסן בברזיל מתנהל לאט, נדרשת יותר זמינות שלי לטיפול בנושא`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. התקבלו שתלי זיגומה צרה לבדיקות
...
3. יצאו הזמנות לחלקי CAD/CAM חדשים`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. ספק ישראלי עבור ביצוע בקרת איכות ליצרנים בסין`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. החלקים שיותרו בלעדית ע"י מיקרומיל הועברו לע.ל.נ לצורך הוכחת יכולת ייצור`,
  ...
  make({
    ...
    reviewed: false,
    previousWeekUpdate: ``,
    currentWeekUpdate: `1. בוצע פיילוט
